...
const generateHttpErrors = function() {
    const errors = {};
    ...
    for (const code of Object.keys(STATUS_CODES)) {
        ...
        const errorClass = ({
            // Create a class has dynamic 'class name' (or constructor function name).
        ...
        errors[code] = errors[name] = errorClass;
    }
 ...
 * }}
 */
const HttpErrors = generateHttpErrors();
